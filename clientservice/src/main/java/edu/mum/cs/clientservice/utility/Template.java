...
public class Template {
    ...
    public static String urlString = "http://CLIENT-SERVICE/";
    ...
    public static String sendingEmail(String message) {
        ...
        body.append("<!DOCTYPE html PUBLIC -//W3C//DTD XHTML 1.0 Transitional //EN http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd><html xmlns=http://www.w3.org/1999/xhtml><head>\n" +
                ...
                "                      <h1 style=\"Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #44596b;font-size: 26px;line-height: 34px;text-align: center\";><strong><span style=\"color: #F15A24\";></span>E-COMMERCE MIS</strong></h1> \n" +
                "                    </div> \n" +
                "                 \n" +
                "                    <div style=\"Margin-left: 20px;Margin-right: 20px\";> \n" +
                "                      <h1 style=\"Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: gray;font-size: 18px;line-height: 34px;text-align: center\";><strong>INFORMATION</strong></h1> \n" +
                "                    </div> \n" +
                "        \n" +
                "                       <div style=\"Margin-left: 20px;Margin-right: 20px\";> \n" +
                ...
                "                        <a style=\"border-radius: 4px;display: inline-block;font-weight: bold;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff;background-color: #002F54;font-family: Avenir, sans-serif;font-size: 14px;line-height: 24px;padding: 12px 35px\"; href=\"" + urlString + "/login/"+""+"\">LOGIN</a> \n" +
                "                      </div> \n" +
                "                    </div> \n" +
                "                            <div style=\"Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px\";> \n" +
                "                      <div style=\"text-align:center\";> \n" +
                "                        If you are not able to click the button above, copy and paste the following link in your browser: <a style=\"display: inline-block;font-weight: bold;text-align: center;font-family: Avenir, sans-serif\"; href=\"" + urlString + "/login/"+""+"\">" + urlString + "/login/" +""+"</a>\n" +
                "                      </div> \n" +
                "                    </div> \n" +
                "                     \n" +
                "                          </td> \n" +
